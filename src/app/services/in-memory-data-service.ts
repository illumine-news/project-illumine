...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const editorials = [
      { id: 21, editorialName: 'Journalism in numbers', authorName: "Nate Silver", organizationName: "FiveThirtyEight", datePublished: new Date('December 17, 1995 03:24:00'), illumineScore: 99 },
